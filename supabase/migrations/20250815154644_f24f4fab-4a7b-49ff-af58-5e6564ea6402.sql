...
-- Re-create public function to list businesses with safe columns including social media
...
-- Re-create function to get a single business (safe columns including social media)
